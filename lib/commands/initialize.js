...
class Initialize extends sjsc_command_1.default {
    ...
    async configurePackageJson(args) {
        const pkgJsonStr = await fs_extra_1.readFile("package.json", "utf-8");
        const pkgJson = Object.assign(Object.assign({}, JSON.parse(pkgJsonStr)), { name: `@${args.organization}/${args.repository}`, version: "0.0.0", main: "./packages/cjs/common.js", module: "./packages/es/common.js", files: [
                "packages/"
            ] });
